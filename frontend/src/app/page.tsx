...
import { Button, Card, Space, Divider, Layout } from "antd";
import {
  ArrowRightOutlined,
  BulbOutlined,
  RobotOutlined,
        ...
        <div className="container">
          ...
          <section className="text-center mt-10 px-5 py-10">
            ...
            <Space size="middle">
              ...
              >
                {isAuthenticated ? "Начать проект" : "Войти"}
              </Button>
              {isAuthenticated && (
                <Button
                  size="large"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[1.1rem] text-[#4b4b53] leading-[1.8]">
                  ...
                  генерации текстового описания с указанием стиля, палитры и
                  ограничений.
                </p>
              </div>
                ...
                <div className="flex flex-col gap-6 w-full">
                  <div>
                    ...
                    <p className="text-base text-gray-500 mt-1">
                      Автоматический сбор moodboard&apos;а и текстового описания
                      на основе скрытых описаний ваших предпочтений.
                    </p>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-[#4b4b53] leading-relaxed">
                  Заказчик выбирает изображения интуитивно, а система работает с
                  их скрытыми описаниями. Человек оценивает визуал, а алгоритм
              ...
              >
                ...
                <p className="text-[#4b4b53] leading-relaxed">
                  Автоматическая генерация moodboard&apos;а и черновика снимает
                  с дизайнера рутину сбора материалов, освобождая драгоценное
                  время для по-настоящему творческих задач.
                </p>
              </Card>
              <Card
                hoverable
